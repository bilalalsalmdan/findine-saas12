...
import { Hotel, Utensils, Wifi, Star } from "lucide-react";

const features = [
  { icon: Hotel, title: "خدمة الغرف", description: "طلبات مباشرة من غرف الضيوف" },
  { icon: Wifi, title: "WiFi Marketing", description: "صفحة ترحيب مخصصة للضيوف" },
  { icon: Star, title: "تقييمات", description: "جمع تقييمات الضيوف بسهولة" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            حلول متكاملة لإدارة المطاعم والمقاهي في الفنادق
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">جاهز لتحويل تجربة ضيوفك؟</h2>
